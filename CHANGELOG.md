...
- Added templates: agent card, data manifest, autonomy run log.
- Added getting-started guide, manuscript mapping, and issue template.
- Added illustrative triangle graphic and CC-BY-4.0 license.
